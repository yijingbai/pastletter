...
INSERT INTO image (`image_id`, `src`, `type`, `title`, `titlea`, `imagea`, `page`, `level`, `language`, `add_time`) VALUES (25, 'http://localhost/pastletter/uploads/Chouchin_Reinensai_(Lantern).gif', 0, '0', '0', 'http://www.greatline.ee', 1, 3, 1, '2012-04-17 11:36:14');
...
INSERT INTO user (`user_id`, `name`, `password`, `email`, `status`, `admin`, `add_time`) VALUES (3, 'cccc', '123', 'wef', 1, 0, '2012-04-16 16:19:39');
INSERT INTO user (`user_id`, `name`, `password`, `email`, `status`, `admin`, `add_time`) VALUES (4, 'dddd', '123', 'wef', 1, 0, '2012-04-16 16:19:40');
