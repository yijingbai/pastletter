...
<div id='inline_content' style='background:#fff;width:622px;height:358px;'>
	...
	<div id="waikuang">
        ...
        <div id="zuo"></div>
        <div id="center">
		<div class="biaoti"><p style = "margin-left:5px;"><i><?php echo $this->lang->line("resetyourpass")?></i></p><hr style="width:480px;float:left;margin-left:1px;margin-top:0px;">
			
		
			<form class="well"  method="post" action = "<?php echo base_url("userctl/resetpass/".$key."/".$id)?>">
				...
				<button type="submit" class="btn"><?php echo $this->lang->line('reset')?></button>
			</form>
