        ...
        <div id="footer"><div id="kuan"><img src="<?php echo base_url("static/img/index_fullscreen_27.jpg")?>"><hr style="margin-top:3px;float:left;width:1002px;" /><div id="copyright">Copyright © 2012 - pastletter labs - All rights reserved.
        </div>
            <div id="sigetu">
                <ul>
