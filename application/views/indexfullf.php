...
alert("sdf");
 document.getElementById('safecode').src="<?php echo base_url("showimg")?>"
	...
	function changeurlsubmit() {
		...
		form.action = "<?php echo base_url('welcome/fullfilldata/1')?>"
		form.submit();
	}
</script>
<div id="leftkuang">
       <div id="xietiao">
			...
			<form id = "pastl" class="form-horizontal" method="post" action = "<?php echo base_url("/letterctl/insertLetterToPast")?>"  style = "height:100%; float:left;">
			        <fieldset>
    ...
    <div id="lan1" class="lan lan-bian">
        <div id="dear"><b>Dear PastMe</b></div>
