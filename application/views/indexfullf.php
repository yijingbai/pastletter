...
<div id="leftkuang" style = "">
						            ...
						            <div class="controls" style = "margin-top:8px;">
						              <img id = "safecode" style = "height:25px;float:left" onClick="reloadcode();" src="<?php echo base_url("showimg/user")?>">&nbsp;<input type="text" style = "width:60px;height:20px;" name = "passcode" id="input03" >	<span class="help-inline"><?php echo form_error('passcode')?></span>
										...
										<div class="control-group" >
											...
											<img onClick= "submitfuture();" src="<?php echo base_url("static/img/sendtofuturecn-wuyinying.png"); ?>" style="<?php if ($this->session->userdata("language")==1) { echo "display:none;"; } else { echo ""; } ?>float:right;margin-top:-150px;margin-right:0px;">
											<img onClick= "submitfuture();" src="<?php echo base_url("static/img/senttofuture-wuyinying.png");?>" style="<?php if ($this->session->userdata("language")==2) { echo "display:none;"; } else { echo ""; } ?>float:right;margin-top:-150px;margin-right:0px;">
				        </fieldset>
				      </form>
    ...
    <div id="lan1" class="lan lan-bian">
	    ...
	    width: 37em;/*不允许出现半汉字截断*/height:5em;
    ...
    <div id="kongbai"><div id="kongbai-zi"> <p style="font-size:11px;font-family:Verdana;color:#2d2d2d;margin-top:-15px;float:left;"><?php echo $this->lang->line("morethan")?>&nbsp;<?php $count=$data["count"];$count = $count[0]; $count=$count["amount"];echo $count;  ?>&nbsp;<?php echo $this->lang->line('lettertofuture'); ?></p></div></div>